...
5. **M1 MBP 不支援 USB Gadget RNDIS**（HoRNDIS 只支援 Intel Mac）→ 第一次 SSH 必須在 PC 上做
...
# 4. 拔卡塞 NanoPi，MicroUSB 接 PC，等 1-2min
ssh root@192.168.100.1   # 密碼 fa
