...
| 選項 | 顆數 | 約價 NT$ | 浪費 | 焊接需求 | 對 use case 契合度 |
|---|---|---|---|---|---|
| 裸晶片 5050 SMD（10 顆裝） | 10 | 60 | 0（5 顆備品） | 高（SMD 手焊） | ✓，但要會焊 |
| 1m 60-LED 燈條 | 60 | 150–200 | 55 | 中（焊 3 條粗線） | 直線排列契合 PR pipeline |
| **8 LED Ring** | **8** | **80–150** | **3** | **0（買預焊版）** | **★ 環形對狀態燈 UX 最佳** |
| 12 LED Ring | 12 | 100–180 | 7 | 0 | OK 但浪費較多 |
| 16 LED Ring | 16 | 100–200 | 11 | 0 | 體積偏大 |
| 24 LED Ring | 24 | 150–300 | 19 | 0 | 浪費過多 |
| Jewel 7（1 中心 + 6 周圍） | 7 | 100–200 | 2 | 0 | 中心 + 周圍可分主次狀態 |
| Stick 8（直線） | 8 | 80–150 | 3 | 0 | 直線版替代方案 |
