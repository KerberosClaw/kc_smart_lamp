...
| # | 物件 | 規格 / 必須條件 | 約價 NT$ |
|---|---|---|---|
| 1 | ESP32-C3 SuperMini | **排針已焊好** | 100–220 |
...
> **備註：實體材料行 vs 網購的價差** — 上面區間是台中實體電子材料行的常見價格。蝦皮 / 露天 / Aliexpress 同一顆 SuperMini 可能 NT$ 80–120，但**第一次跑硬體建議去實體店**，理由見下節「為什麼要到現場看（不能直接網購）」。
...
- **型號 / 板廠變體多**：ESP32-C3 SuperMini 光是「板上 LED 顏色 / RESET 鍵位置 / USB 孔朝向」就好幾個版本，不同批次可能規格小差
- **排針有沒有焊**：網購圖片不一定反映實物，到現場看才確認
- **代焊服務通常沒有**（今華電子確認沒有）→ 排針沒焊好就要自己焊或換店
- **接線品質**：WS2812B Ring 預焊接線品質差很多，現場捏一下就知道
- **問題即時解**：現場直接問店員相容性、供電方案，比 Q&A 來回快

**結論**：第一次跑硬體去實體店，貴一點但少踩坑。網購留給「我已經知道要買哪顆 SKU、補料」的階段。
...
**已知資訊**：今華電子（2026-04-26 電話確認）— 沒有代焊服務，老闆建議到現場看型號。其他店待跑。
...
沒有的話，有沒有別款 ESP32 開發板，是出廠就焊好排針的？
